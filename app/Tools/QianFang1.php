...
class QianFang1{
	// 10076800377
	private $payKey    = "";//商户支付Key
	private $paySecret = "";//商户支付密钥
	// 15876800377
	// private $payKey    = "";//商户支付Key
	// private $paySecret = "";//商户支付密钥
	// 
	...
	public function pay($pram=array()){
		...
		// $returnUrl = "http://www.*****.com/other/return.php";//支付成功同步通知地址
		// $notifyUrl = "http://www.*****.com/other/notify.php";//后台异步通知地址
		$data['returnUrl']= $pram['ReturnUrl'];
		$data['notifyUrl']= $pram['NotifyUrl'];
	...
	public function bankCardPay($pram=array()){
		...
		$payUrl = "http://******.com/quickGateWayPay/initPay";//打款地址
