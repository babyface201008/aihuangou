...
class McyWxInfoController  extends Controller
{    
  ...
  public function wxInfo(Request $request)
  {
  	...
  	$wxinfo = McyWxInfo::where('is_delete',0)->where('user_id',$admin_id)->first();
  	return view('welkin.mcy.wxinfo',compact('wxinfo'));
  }
}
