...
class McySiteInfoController  extends Controller
{    
  ...
  public function siteInfo(Request $request)
  {
  	...
  	$siteinfo = McySite::where('is_delete',0)->where('user_id',$admin_id)->first();
  	return view('welkin.mcy.siteinfo',compact('siteinfo'));
  }
}
