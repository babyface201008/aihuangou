...
class CategoryController extends Controller
{
	...
	public function category(Request $request)
	{
		...
		if ($searchtext !== '')
		{
			$categorys  = Category::where('category.is_delete',0)
							...
							->select('category.user_id','category.category_id','category.name','welkin_user.nickname','welkin_user.username','category.created_at')
							->paginate(20);
		}else{
			$categorys  = Category::where('category.is_delete',0)
							->join('welkin_user','welkin_user.user_id','=','category.user_id','left')
		...
		return view('welkin.category',compact('categorys','searchtext','starttime','endtime'));
	}
	...
	public function categoryCreate(Request $request)
	{
		...
		return view('welkin.category_create',compact('admin'));
	}
	...
	public function categoryUpdate(Request $request)
	{
		...
		return view('welkin.category_update',compact('admin','category'));
	}
