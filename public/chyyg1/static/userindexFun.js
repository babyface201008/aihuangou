            ...
            var v = function() {
                ...
                var y = function(I) {
                    ...
                    if (I.code == 0) {
                        ...
                        for (var D = 0; D < C; D++) {
                            var F = B[D];
                            var H = F.zongrenshu - F.canyurenshu;
                            var A = F.zongrenshu;
                            var G = parseFloat(H * 100 / A);
                            var z = Math.ceil(G);
                            E += "<ul onclick=\"location.href='"+Gobal.Webpath+"/product?qishu="+ F.qishu + "&product_id=" + F.shopid + '\'"><li class="mBuyRecordL">';
                            E += '<img src2="'+ F.thumb + '" src="' + Gobal.LoadPic + '"></li>';
                            E += '<li class="mBuyRecordR"><p class="BRtitle">(第' + F.qishu + '期)' + F.title + '</p><p class="mValue">价值：¥' + F.money + '</p>';
                            var timestamp1 = Date.parse(new Date())/1000;
                            if (F.codeState == 3 ) {
                                E += '<span>获得者：<a style="color:#008de7" href="'+Gobal.Webpath+'/userinfo/' + F.q_uid + '">' + F.q_user + '</a><br>幸运云购码：<em class="orange">' + F.q_user_code + "</em></span>"
                            } else {
                                ...
                                E += '<li class="P-bar02">总需：<em style="display: inline-block;">' + F.zongrenshu + '</em></li><li class="P-bar03">剩余：<em class="blue" style="display: inline-block;">' + (F.canyurenshu) + "</em></li>";
                                E += "</ul></div></div>"
                            }
                            E += "</li></ul>"
                        }
                ...
                GetJPData(Gobal.Webpath, "userinfo", "getUserBuyList"+w(),y)
            };
            ...
            var v = function() {
                var y = function(z) {
                    if (z.code == 0) {
                        ...
                        for (var A = 0; A < E; A++) {
                            var C = D[A];
                            B += "<ul onclick=\"location.href='"+Gobal.Webpath+"/going/product?qishu=" + C.qishu +"&product_id=" + C.shopid + '\'" class="BuyRecordList"><li class="mBuyRecordL">';
                            B += '<img src2="' + C.thumb + '" src="' + Gobal.LoadPic + '"></li>';
                            B += '<li class="mBuyRecordR"><p class="BRtitle">(第' + C.qishu + "期)" + C.title + '</p><p class="mValue">价值：¥' + C.money + "</p>";
                ...
                var y = function(H) {
                    if (H.code == 0) {
                        ...
                        for (var E = 0; E < D; E++) {
                            ...
                            F += '<li><a href="'+Gobal.Webpath+'/mobile/shaidan/detail/' + G.sd_id + '"><h3><b>' + G.sd_title + "</b><em>" + G.sd_time + "</em>";
                            F += "<p>" + z + "</p></h3><dl>";
