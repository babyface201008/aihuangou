$(function() {
    ...
    if (m) {
        ...
        Base.getScript(Gobal.Skin + "/chyyg1/GoodsTimeFun.js",
        function() {
        ...
        var l = function(r) {
		//alert(p)
		    GetJPData(Gobal.Webpath, "cart", "addShopCart/" + p + "/" + 1,
            function(s) {
                if (s.code == 0) {
                    if (r == 0) {
                        ...
                        location.href = Gobal.Webpath+"/cartlist"
                    }
                } else if (s.code == 2) {
                    d('添加失败，购物车已满');
                } else {
        ...
        Base.getScript(Gobal.Skin + "/chyyg1/pageDialog.js", i);
        var g = $("#divAutoRTime");
        if (g.length > 0) {
            var o = g.attr("time");
            if (o) {
                ...
                Base.getScript(Gobal.Skin + "/chyyg1/CountdownFun.js",
                function() {
                    g.countdowntime(e, k)
                });
				//获取当前商品
    ...
    var a = function() {
        ...
        Base.getScript(Gobal.Skin + "/chyyg1/GoodsPicSlider.js?v=130826",
        function() {
            $("#sliderBox").picslider()
        })
    };
    Base.getScript(Gobal.Skin + "/chyyg1/PeriodSlider.js?v=130826", a)
});