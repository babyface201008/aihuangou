$(function() {
    var a = function() {	 
        ...
        var r = function() {
            ...
            var y = function() {
                d.show();				 
               // GetJPData("http://m.sz1yyg.com", "getUserRecharge", w(),
                ...
                function(D) {
                    if (D.code == 0) {
                        ...
                        if (v.isCount == 1) {
                            x = D.count;
                            v.isCount = 0;
                            B = '<li class="m-userMoneylst-tt"><span>充值金额</span><span>充值渠道</span><span>充值时间</span></li>'
                        }
                        var C = D.listItems;
                        var A = C.length;
                        for (var z = 0; z < A; z++) {
                            B += '<li class="' + (z + 1 == A ? "bornone": "") + '"><span><font color="#dc332d;"> ¥ ' + C[z].money + "</font></span><span>" + C[z].content + "</span><span>" + C[z].time + "</span></li>"
                        }
                        if (v.FIdx > 0) {
                ...
                function(D) {
                    if (D.code == 0) {
                        ...
                        if (v.isCount == 1) {
                            v.isCount = 0;
                            x = D.count;							 
                            B = '<li class="m-userMoneylst-tt"><span>消费金额</span><span>消费时间</span></li>'
                        }
                        var C = D.listItems;
                        var A = C.length;
                        for (var z = 0; z < A; z++) {
                            B += '<li class="' + (z + 1 == A ? "bornone": "") + '"><span><font color="#dc332d"> ¥ ' + C[z].money + "</font></span><span>" + C[z].time + "</span></li>"
                        }
                        if (v.FIdx > 0) {
