...
$(function() {
                ...
                if (w == "" || w == o.txtpwd) {
                    ...
                    if (!f(y) && !d(y)) {
                        ...
                        if (!r(w)) {
                            ...
                            GetJPData(Gobal.Webpath, "mcy", "user/dologin/" + y + "/" + base64encode(utf16to8(w)), x)
    ...
    var a = function() {
        Base.getScript(Gobal.Skin + "/chyyg1/pageDialog.js", b)
    };
    Base.getScript(Gobal.Skin + "/chyyg1/Comm.js", a);
