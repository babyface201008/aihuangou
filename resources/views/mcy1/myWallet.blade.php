<!DOCTYPE html>
<!-- saved from url=(0041)//myInfo.htmmywallet.do -->
<html lang="en">
...
<body class="g-acc-bg" style="zoom: 1;">
    ...
    <div class="m-purse-wrapper">
        <input name="hdIsMobile" type="hidden" id="hdIsMobile" value="1">
        <!--是否绑定手机号-->
        <input name="hdIsPayPwd" type="hidden" id="hdIsPayPwd" value="0">
        <!--是否已设置支付密码-->
        <input name="hdBalance" type="hidden" id="hdBalance" value="0.00">
        <!--余额-->

        <div class="m-purse-head thin-bor-bottom">
            <div class="m-purse-title flex-box" id="btnAccountDetails">
                <div class="money">
                    <p>账户余额</p>
                    <strong class="orange">￥<b id="bBalance">0.00</b></strong>
                </div>
                <p class="gray9">查看明细</p>
                <i class="m-set"></i>
            </div>
            <div class="m-purse-menu thin-bor-top flex-box">
                <a href="javascript:;" class="box thin-bor-right" id="btnTransferMoney">转账</a>
                <a href="/netBanker.htm" class="box thin-bor-right" id="btnRechargeWY">网银充值</a>
                <a href="/netBanker.htm" class="box" id="btnRechargeCard">云购充值卡</a>
            </div>
        </div>

        <div class="m-purse-list">
            <ul class="thin-bor-top">
                <li class="thin-bor-bottom" id="btnUserPoints">
                    <a href="/myBlessing.htm">
                        <span class="gray9">福分</span>
                        <span id="lblPoints" class="orange">20</span>
                        <span class="tips grayb">100福分=1元</span>
                        <i class="m-set"></i>
                    </a>
                </li>
                <li class="thin-bor-bottom" id="btnCommissionDetails">
                    <a href="/CommisionDetail.htm">
                        <span class="gray9">佣金</span>
                        <span class="orange">￥<b id="lblCommission">0.00</b></span>
                        <i class="m-set"></i>
                    </a>
                </li>
            </ul>
    ...
    <script language="javascript" type="text/javascript" src="./static/MyWallet.js"></script>
    ...
    <script language="javascript" type="text/javascript" src="./static/MyWalletFun.js"></script>
