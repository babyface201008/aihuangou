<!DOCTYPE html>
<!-- saved from url=(0051)//myInfo.htmMobileCheck.do?type=1 -->
<html>
...
<body class="secrityBg" style="zoom: 1;">
    ...
    <div class="h5-1yyg-v11">
        ...
        <section>
            <input name="hidMobile" type="hidden" id="hidMobile" value="18988938574">
            <input name="hidPageType1" type="hidden" id="hidPageType1" value="1">
    ...
    <script language="javascript" type="text/javascript" src="./static/MobileCheck.js"></script>
    ...
    <script language="javascript" type="text/javascript" src="./static/MobileCheckFun.js"></script>
