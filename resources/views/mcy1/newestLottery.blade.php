<!DOCTYPE html>
<!-- saved from url=(0030)/newestLottery.htm  -->
<html>
...
<body id="loadingPicBlock" fnav="1" class="g-acc-bg" style="zoom: 1;">
    ...
    <div class="column-wrapper m-site-column">
    ...
    <div class="marginB">
        ...
        <div class="rev-con">
            <ul class="rev-list" id="divLottery">
                <li id="12664506">
                    <div class="pro-img">
                        <a href="./productDetailCount.htm"><img src="./static/20160718164454605.jpg"></a>
                        </div>
                    <div class="pro-info">
                        <h6 class="pro-title gray6">(第117051云) 中国黄金 薄片财富金条 Au9999 2g</h6>
                        <p class="gray9">价值：￥<em>660.00</em></p>
                        <p class="gray9">揭晓倒计时：</p>
                        <div class="pro-state">
                            <div class="time-wrapper"> <em>02</em> <span>:</span> <em>52</em> <span>:</span> <em>					<i>7</i><i>6</i>				</em> </div>
                        </div>
                    </div>
                </li>
                <li id="12669730">
                    <div class="pro-img"><a href="./productDetailCount.htm"><img src="./static/20170310160621945.jpg"></a></div>
                    <div class="pro-info">
                        <h6 class="pro-title gray6">(第222515云) 平安银行 平安福金章 Au9999 2g</h6>
                        <p class="gray9">价值：￥<em>660.00</em></p>
                        <p class="gray9">揭晓倒计时：</p>
                        <div class="pro-state">
                            <div class="time-wrapper"> <em>02</em> <span>:</span> <em>49</em> <span>:</span> <em>					<i>7</i><i>6</i>				</em> </div>
                        </div>
                    </div>
                </li>
    ...
    <script language="javascript" type="text/javascript" src="./static/Lottery.js"></script>
    ...
    <script language="javascript" type="text/javascript" src="./static/LotteryFun.js"></script>
    <script language="javascript" type="text/javascript" src="./static/pageDialog.js"></script>
    <script language="javascript" type="text/javascript" src="./static/LotteryTimeFun.js"></script>
