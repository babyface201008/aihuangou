<!DOCTYPE html>
<!-- saved from url=(0044)//myInfo.htmconsumption.do -->
<html>
...
<head>
    ...
    <link href="./static/accounts.css" rel="stylesheet" type="text/css">
...
<body fnav="1" class="g-acc-bg" style="zoom: 1;">
    ...
    <input name="hidHasMoney" type="hidden" id="hidHasMoney" value="0">
    <div>
        <div id="divNav" class="acc-menu">
            <a href="javascript:;" class="z-checked">消费明细</a>
            <a href="javascript:;">充值明细</a>
            <a href="javascript:;">转账记录</a>
        </div>
        <div id="divConsumption" class="g-accounts-details g-consumption clearfix">
            <h4 class="gray9 bgColor-white" style="display:none;">消费总额：￥</h4>
            <dl>
        ...
        <div id="divRechage" class="g-accounts-details g-recharge-details clearfix" style="display: none;">
            <h4 class="gray9 bgColor-white" style="display:none;">充值总额：￥</h4>
            <dl>
                <dt><span>充值时间</span><span>金额</span><span>渠道</span></dt>
            </dl>
            <div class="loading clearfix g-acc-bg"><b></b>正在加载</div>
        </div>

        <div id="divTransfer" class="g-accounts-details g-transfers-details clearfix" style="display: none;">
            <h4 class="gray9 bgColor-white" style="display:none;">转入总额：￥<cite>转出总额：￥</cite></h4>
            <dl>
                <dt><span>时间</span><span>金额</span><span>对方账号[状态]</span></dt>
            </dl>
            <div class="loading clearfix g-acc-bg"><b></b>正在加载</div>
        </div>
        ...
        <div class="pro_foot">
            <ul>
                <li id="btnTransfer" class="border-orange-Btn"><a href="javascript:;">转账</a></li>
                <li><a href="/netBanker.htm" class="orangeBtn">去充值</a></li>
            </ul>
        </div>
    ...
    <script language="javascript" type="text/javascript" src="./static/consumptionlist.js"></script>
    ...
    <script language="javascript" type="text/javascript" src="./static/ConsumptionListFun.js"></script>
