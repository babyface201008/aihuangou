<!DOCTYPE html>
<!-- saved from url=(0041)//myInfo.htmrecharge.do -->
<html>
...
<body class="g-acc-bg" style="zoom: 1;">
    ...
    <div class="acc-menu g-rechargeNav">
        <a href="/netBanker.htm" class="z-checked">网银充值</a>
        <a href="/netBanker.htm">充值卡充值</a>
    </div>

    <div class="g-accounts-details">
        <h4 class="gray9">您的当前余额：<em class="orange">￥0.00</em></h4>
    </div>

    <div class="g-Recharge clearfix">
        <ul id="ulOption">
            <li money="50" class="checked"><a href="javascript:;">50元</a>
                <s class="z-set"></s>
            </li>
            <li money="100"><a href="javascript:;">100元</a>
                <s class="z-set"></s>
            </li>
            <li money="200"><a href="javascript:;">200元</a>
                <s class="z-set"></s>
            </li>
            <li money="500"><a href="javascript:;">500元</a>
                <s class="z-set"></s>
            </li>
            <li money="1000"><a href="javascript:;">1000元</a>
                <s class="z-set"></s>
            </li>
            <li>
    ...
    <div class="g-accounts-details">
        <h4 class="gray6">充值金额<i class="orange" id="iRechargeMoney">50.00</i>元</h4>
    </div>

    <div class="online-banking clearfix">
        <dl id="ulBankList">
            <dt><a href="javascript:;">选择网银</a></dt>
            <dd class="checked" type="jdPay"><a href="javascript:;">京东支付</a>
                <s class="z-set"></s>
            </dd>
        </dl>
    </div>
    ...
    <div class="f-Recharge-btn">
        <a id="btnSubmit" href="https://m.jdpay.com/wepay/web/pay" class="orangeBtn">确认充值</a>
    </div>
    ...
    <script language="javascript" type="text/javascript" src="./static/userRecharge.js"></script>
    ...
    <script language="javascript" type="text/javascript" src="./static/userRechargeFun.js"></script>
