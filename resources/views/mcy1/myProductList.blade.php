<!DOCTYPE html>
<!-- saved from url=(0042)//myInfo.htmorderlist.do -->
<html>
...
<body id="loadingPicBlock" fnav="1" class="" style="zoom: 1;">

    <!--触屏版内页头部-->
    <div class="m-block-header" id="div-header" style="display: block;">
        <strong id="m-title">获得的商品</strong>
    ...
    <input name="hidTimeSpan" type="hidden" id="hidTimeSpan" value="1497630298">
    <input name="hidNonceStr" type="hidden" id="hidNonceStr" value="bSTzxMpiKinMcvwH">
    <input name="hidSignature" type="hidden" id="hidSignature" value="243b198964207ab46c9db24b6a9bf5707258adca">
    <div>
        <div class="m_buylist m_get">
            <ul id="ul_list">
                <div class="noRecords colorbbb clearfix">
                    <s class="z-y9"></s>主银，您最近还没有获得商品哦~</div>
                <div class="hot-recom">
                    <div class="title thin-bor-top gray6"><span><b class="z-set"></b>人气推荐</span><em></em></div>
                    <div class="goods-wrap thin-bor-top">
                        <ul class="goods-list clearfix">
                            <li><a href="//v41/products/24003.do" class="g-pic"><img src="./static/20170414155920834.jpg" width="136" height="136"></a>
                                <p
                            ...
                            <li><a href="//v41/products/23251.do" class="g-pic"><img src="./static/20160530174846601.jpg" width="136" height="136"></a>
                                <p
                            ...
                            <li><a href="//v41/products/23924.do" class="g-pic"><img src="./static/20170320164351202.jpg" width="136" height="136"></a>
                                <p
                            ...
                            <li><a href="//v41/products/23490.do" class="g-pic"><img src="./static/20160923090132510.jpg" width="136" height="136"></a>
                                <p
    ...
    <script language="javascript" type="text/javascript" src="./static/OrderList.js"></script>
    ...
    <script language="javascript" type="text/javascript" src="./static/OrderListFun.js"></script>
    <script language="javascript" type="text/javascript" src="./static/pageDialog.js"></script>
    <script language="javascript" type="text/javascript" src="./static/GuessGoodsFun.js"></script>
