<!DOCTYPE html>
<!-- saved from url=(0049)//myInfo.htmmembermodify.do?t=1 -->
<html>
...
<body fnav="1" class="g-acc-bg" style="zoom: 1;">
    ...
    <input name="hidOldName" type="hidden" id="hidOldName" value="USER.1016069267">
    <input name="hidFlag" type="hidden" id="hidFlag" value="1">


    <div class="edit-wrapper">
        <input name="txtUserName" type="text" id="txtUserName" class="inp-info" maxlength="20" value="USER.1016069267">
