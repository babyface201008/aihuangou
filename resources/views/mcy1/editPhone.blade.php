<!DOCTYPE html>
<!-- saved from url=(0049)//myInfo.htmmembermodify.do?t=4 -->
<html>
...
<body fnav="1" class="g-acc-bg" style="zoom: 1;">
    ...
    <input name="hidFlag" type="hidden" id="hidFlag" value="4">



    <div class="edit-wrapper">
        <input name="txtPhone" type="text" id="txtPhone" class="inp-info" maxlength="20">
        <p class="txt">备用联系信息不作公开</p>
        <a id="btnT4" href="javascript:;" class="s-btn">保存</a>
    </div>
