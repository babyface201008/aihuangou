<!DOCTYPE html>
<!-- saved from url=(0044)//myInfo.htmmentionList.do -->
...
<body fnav="1" class="g-acc-bg" style="zoom: 1;">
    ...
    <script language="javascript" type="text/javascript" src="./static/MentionList.js"></script>
    ...
    <script language="javascript" type="text/javascript" src="./static/MentionListFun.js"></script>
