<!DOCTYPE html>
<!-- saved from url=(0045)//myInfo.htmgoodsbuylist.do -->
<html>

<head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <script async="" src="./static/JPData"></script>
...
<body id="loadingPicBlock" fnav="1" class="" style="zoom: 1;">
    ...
    <div class="m-block-header" id="div-header" style="display: block;">
        <strong id="m-title">我的云购记录</strong>
    ...
    <input name="hidTimeSpan" type="hidden" id="hidTimeSpan" value="1497630123">
    <input name="hidNonceStr" type="hidden" id="hidNonceStr" value="gVCQzie95yp2aSJl">
    <input name="hidSignature" type="hidden" id="hidSignature" value="af870202072f560160097fc1324bbaee1ccfe354">

    <div>
        <div id="divBuyList" class="m_buylist m_buylist_n">
            <ul id="ul_list">
                <div class="noRecords colorbbb clearfix">
                    <s class="z-y8"></s>最近还没有参与云购？<br> 梦想与您只有1元的距离！~</div>
            </ul>
    ...
    <script language="javascript" type="text/javascript" src="./static/userbuylist.js"></script>
    ...
    <script language="javascript" type="text/javascript" src="./static/UserBuyListFun.js"></script>
    ...
    <div id="div_fastnav" class="fast-nav-wrapper">
        ...
        <div class="sub-nav five" style="display:none;"><a href="//index.htm"><i class="home"></i>云购</a><a href="//newestLottery.htm "><i class="announced"></i>最新揭晓</a>
            <a href="//orderShare.htm"><i class="single"></i>晒单</a><a href="//myInfo.htm"><i class="personal"></i>我的云购</a>
            <a
                href="//shoppingCart.htm"><i class="shopcar"></i>购物车</a>
        </div>
    </div>
</body>
