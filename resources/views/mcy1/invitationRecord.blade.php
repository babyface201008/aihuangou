<!DOCTYPE html>
<!-- saved from url=(0043)//myInfo.htminvitelist.do -->
<html>
...
<body fnav="1" class="g-acc-bg" style="zoom: 1;">
    ...
    <script language="javascript" type="text/javascript" src="./static/InviteList.js"></script>
    ...
    <script language="javascript" type="text/javascript" src="./static/InviteListFun.js"></script>
