<!DOCTYPE html>
<!-- saved from url=(0050)http://weixin.1yyg.com/v40/post/GoodsPost-23559.do -->
<html>
...
<body id="loadingPicBlock" class="g-acc-bg" fnav="1" style="zoom: 1;">
    ...
    <div>
        ...
        <div class="g-statistics gray9" id="div_title" style="">已有<em class="gray6">26</em>位幸运用户晒单<span>总共<em class="orange">72</em>条评论</span></div>
        <div class="g-goods-single">
            <ul id="ul_list">

                <li postid="390450">
                    <p class="fl"><img src="./static/20170330094014519.jpg"></p>
                    <dl>
                        <dt><a href="/personInfo.htm" class="blue">云商品获得者中中大奖</a></dt>
                        <dd class="gray6">苹果电脑来了！</dd>
                        <dd class="gray9">期待已久的高大上电脑终于来了，短信来了激…</dd>
                        <dd class="colorbbb">03月30日 09:42</dd>
                    </dl>
                </li>
                <li postid="389605">
                    <p class="fl"><img src="./static/20170328180312717.jpg"></p>
                    <dl>
                        <dt><a href="/personInfo.htm" class="blue">yG是大马扁子</a></dt>
                        <dd class="gray6">我想要很久的电脑终于有了</dd>
                        <dd class="gray9">再次感谢1元云购这个平台！感谢云友的填坑我…</dd>
                        <dd class="colorbbb">03月28日 18:03</dd>
                    </dl>
                </li>
                <li postid="389448">
                    <p class="fl"><img src="./static/20170327093156611.jpg"></p>
                    <dl>
                        <dt><a href="/personInfo.htm" class="blue">梦醒Yg</a></dt>
                        <dd class="gray6">运气超好的</dd>
                        <dd class="gray9">我这应该是厚而积发吧，？？？？？？，我原…</dd>
                        <dd class="colorbbb">03月27日 16:27</dd>
                    </dl>
                </li>
    ...
    <script language="javascript" type="text/javascript" src="./static/GoodsPost.js"></script>
    ...
    <script language="javascript" type="text/javascript" src="./static/GoodsPostFun.js"></script>
