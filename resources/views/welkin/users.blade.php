            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>用户管理 <small> <a class="btn btn-sm btn-success" href="/welkin/user/create">添加用户</a>
                        </small></h5>
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                 ...
                                 <!--  <td>
                                        ...
                                        <td>
                                        <a class="btn btn-sm btn-info updateuser" href="/welkin/user/update?user_id={{@$user->user_id}}">修改</a>
                                        <button type="button" class="btn btn-sm btn-danger deleteuser" uname="{{@$user->username}}" uid="{{@$user->user_id}}" >删除</button>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
...
@section('my-js')
    ...
    $(".btnsearch").on('click',function(){
        ...
        location.href = '/welkin/users?searchtext='+ searchtext + '&starttime=' + starttime + '&endtime='+ endtime;
    });
