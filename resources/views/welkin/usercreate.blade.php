            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>添加用户<small><a href="/welkin/users">返回用户列表</a></small></h5>
                                                ...
                                                <div class="smart-widget-body">
                                                    <form class="form-horizontal no-margin" id="article_create">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <input type="text" class="form-control input-sm" placeholder="用户名称" datatype="*" name="username" errmsg="用户名称不能为空" >
                                                            </div><!-- /.col -->
                                                        </div><!-- /form-group -->                              
                                                        <div class="form-group">
