            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>修改晒单<small><a href="/welkin/mcy/shaidan">返回晒单列表</a></small></h5>
                                        ...
                                        <div class="smart-widget widget-purple">
                                            <div class="smart-widget-inner">
                                                <div class="smart-widget-body">
                                                    <form class="form-horizontal no-margin" id="shaidan_update">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-9">
                                                              <textarea class="shaidan_content" id="shaidan_content" rows=10 cols=50>{{@$shaidan->shaidan_content}}</textarea>
                                                            </div><!-- /.col -->
                                                        </div><!-- /form-group -->
                                                        <div class="form-group">
                                                        <label class="control-label col-lg-3" style="display: none;">晒单人ID</label>
                                                            <div class="col-lg-9">
                                                            <input type="number" value="{{@$shaidan->mcy_user_id}}" class="form-control input-sm" placeholder="晒单人" datatype="*" name="mcy_user_id" style="width:300px;display: none;">
                                                            <input type="hidden" name="shaidan_id" value="{{@$shaidan->shaidan_id}}">
                                                            </div><!-- /.col -->
                                                        </div><!-- /form-group -->   
                                                        <div class="text-right m-top-md">
                                                            <button type="button" class="btn btn-info btn-shaidan-add">修改</button>
                                                        </div>
                                                    </form>
                                                </div>
...
<script type="text/javascript">
    $(".btn-shaidan-add").on('click',function(){
        var data = $("#shaidan_update").serialize();
        $.ajax({
            type : 'post',
            url  : '/api/welkin/mcy/shaidan/update',
            dataType : 'json',
            data : {
                _token   : "{!! csrf_token() !!}",
