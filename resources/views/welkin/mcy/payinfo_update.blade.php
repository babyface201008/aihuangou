                                        ...
                                        <div class="smart-widget widget-purple">
                                            <div class="smart-widget-inner">
                                                <div class="smart-widget-body">
                                                    <form class="form-horizontal no-margin" id="payinfo_update">
                                                        <div class="form-group">
                                                            <label class="control-label col-lg-3">支付名称</label>
                                                            <div class="col-lg-9">
                                                                <input value="{{@$payinfo->pay_name}}" type="text" class="form-control input-sm" placeholder="支付名称" datatype="*" name="pay_name" >
                                                                <input type="hidden" name="payinfo_id" value="{{@$payinfo->payinfo_id}}">
                                                            </div><!-- /.col -->
                                                        </div><!-- /form-group -->      
                                                        <div class="form-group">
                                                            <label class="control-label col-lg-3">支付账号</label>
                                                            <div class="col-lg-9">
                                                                <input value="{{@$payinfo->pay_account}}" type="text" class="form-control input-sm" placeholder="支付账号" datatype="*" name="pay_account" >
                                                            </div><!-- /.col -->
                                                        </div><!-- /form-group -->            
                                                        <div class="form-group">
                                                            <label class="control-label col-lg-3">支付密码</label>
                                                            <div class="col-lg-9">
                                                               <input value="{{@$payinfo->pay_secret}}" type="text" class="form-control input-sm" placeholder="" datatype="*" name="pay_secret">
                                                           </div><!-- /.col -->
                                                       </div><!-- /form-group -->
                                                        <div class="form-group">
                                                            <label class="control-label col-lg-3">产品类型</label>
                                                            <div class="col-lg-9">
                                                                <input type="text" value="{{@$payinfo->product_type}}" class="form-control input-sm" placeholder="产品类型" datatype="*" name="product_type" >
                                                            </div><!-- /.col -->
                                                        </div><!-- /form-group -->
                                                        <div class="form-group">
                                                            <label class="control-label col-lg-3">排序</label>
                                                            <div class="col-lg-9">
                                                                <input value="{{@$payinfo->sort}}" type="number" class="form-control input-sm" placeholder="排序" datatype="*" name="sort" >
                                                            </div><!-- /.col -->
                                                        </div><!-- /form-group -->    
                                                        <div class="form-group">
                                                            <label class="control-label col-lg-3">支付函数方法</label>
                                                            <div class="col-lg-9">
                                                                <input value="{{@$payinfo->method}}"  type="text" class="form-control input-sm" placeholder="支付函数方法" datatype="*" name="method" >
                                                            </div><!-- /.col -->
                                                        </div><!-- /form-group -->    
                                                        <div class="form-group">
                                                        ...
                                                        <label class="control-label col-lg-3">是否启用</label>
                                                           <div class="col-lg-9">
                                                            <select name="status" data-placeholder="选择是否启用..." class="chosen-select" style="width:350px;">
                                                                <option @if($payinfo->status == 0) selected="selected" @endif value="0" hassubinfo="true">启用</option>
                                                                <option @if($payinfo->status == 1) selected="selected" @endif value="1" hassubinfo="true">不启用</option>
                                                            </select>
                                                        </div><!-- /.col -->
                                                        </div><!-- /form-group -->    
...
<script type="text/javascript">
    $(".btn-payinfo-add").on('click',function(){
        var data = $("#payinfo_update").serialize();
        $.ajax({
            type : 'post',
            url  : '/api/welkin/mcy/payinfo/update',
            dataType : 'json',
            data : {
                _token   : "{!! csrf_token() !!}",
