            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>文章列表 <small><a href="/welkin/mcy/article/create">添加文章</a></small></h5>
    ...
    <script>
        function modify_article(article_id,title)
        {
            parent.layer.confirm("确定修改文章标题为" + title + '的文章?',function(){
                ...
                location.href = '/welkin/mcy/article/update?article_id=' + article_id;
            });
        }
        ...
        function delete_article(article_id,title)
        {
            ...
            parent.layer.confirm('确定删除标题为 '+ title + ' 的文章?',function(){
                $.ajax({
                    url      : '/api/welkin/mcy/article/delete',
                    type     : 'post',
                    dataType : 'json',
                    data     : {
                        _token : "{!! csrf_token() !!}",
